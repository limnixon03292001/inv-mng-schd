...
const SelectStatus = ({statusSelected, setStatusSelected, status}) => {
  return (
    <div className="w-36 md:44 mb-3">
        ...
        <div className="relative mt-1">
            ...
            <span className="block truncate">{statusSelected.name}</span>
                ...
                >
                    ...
                    <>
                        ...
                        className={`block truncate ${
                            statusSelected ? 'font-medium' : 'font-normal'
                        }`}
                        >
                        {person.name}
                        </span>
